...
interface SingleComputed<S> {
  //#region homogeneous selector parameter types 
...
//#region Computed
type Computed = SingleComputed<unknown> & {
  //#region homogeneous selector parameter types
  ...
  //#region heterogeneous selector parameter types
  ...
  for<Context>(context: Context): SingleComputed<Context>
}
//#endregion

declare var computed: Computed;
